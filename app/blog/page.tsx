...
const POSTS = [
  ...
  },
  {
    ...
    excerpt: 'Mumbai has no standard dog walking rate. What maids, watchmen and professional walkers actually charge, what moves the price, and the question about duration almost nobody asks.',
    readTime: '6 min read',
    date: 'Sep 16, 2026',
    featured: false,
  },
  {
    ...
    categoryText: '#78350F',
    emoji: '🛰️',
    image: 'https://images.unsplash.com/photo-1477884213360-7e9d7dcc1e48?auto=format&fit=crop&w=900&q=80',
    title: 'How to track your dog\'s walk in real time (and what each method actually costs)',
    excerpt: 'GPS collar, the walker\'s phone, or nothing at all. An honest comparison of all three ways to track your dog\'s walk in India — including where each one fails.',
    readTime: '7 min read',
    date: 'Sep 17, 2026',
    featured: false,
  },
  {
    ...
    categoryText: '#78350F',
    emoji: '🤔',
    image: 'https://images.unsplash.com/photo-1494947665470-20322015e3a8?auto=format&fit=crop&w=900&q=80',
    title: 'You think your dog walker is cutting the walk short. What now?',
    excerpt: 'Short walks, dry paws on a rainy day, identical reports every day. How to tell a real signal from noise, raise it without accusing anyone, and get a record so it never becomes your word against theirs.',
    readTime: '6 min read',
    date: 'Sep 18, 2026',
    featured: false,
  },
